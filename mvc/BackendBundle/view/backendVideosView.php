                    ...
                    <table id="" class="display" cellspacing="0" width="100%">
                            <thead class="thead-columns">
                                <tr>
                                    ...
                                    <th>Estado</th>
                                    <th>Video</th>
                                    <th><a id="button_excel" title ="Excel" href= "#"><img style = "border: 3px ridge #eee; padding:3px; background-color: #FFF;" src = "../img/xls.png" onclick="excel(4);"></a></th>
                            ...
                            <tfoot>
                                <tr>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <span class="btn btn-primary btn-file">                    
                                                        Browse&hellip; <input type="file" accept="video/*" id="dir" name="dir" >
                                                    </span>
                                                </span>
                                    ...
                                    <th>
                                        ...
                                        ?>
                                            <div class="form-group">
                                                <a id="button_add" title ="Agregar" href= "#"><img style = "border: 3px ridge #eee; padding:3px; background-color: #FFF;" src = "../img/add.png" onclick="saveFicherosRow('video');"></a>
                                            </div>
                                        <?php
                                        }
                                        else
                                    ...
                                    <th>
                                        <div class="form-group">
                                            <a id="button_edit" title ="Guardar" href= "#"><img style = "border: 3px ridge #eee; padding:3px; background-color: #FFF;" src = "../img/save.png" onclick="saveFicherosEditRow('video');"></a>
                                        </div>
                                    </th>
                                </tr>
                                <?php
                            ...
                            <tbody class="tbody-columns">
                                ...
                                <tr style="cursor:pointer" class = "desmarcado">
                                    ...
                                    <td>
                                        <a href="../backend/videosDetalle.php?id_video=<?php echo $row['pk_fichero']; ?>"><?php echo $row['directorio']; ?></a>
                                    ...
                                    <td>
                                           <img title="Eliminar" style = "border: 3px ridge #eee; padding:3px; background-color: #FFF;" src = "../img/del.png" onclick="deleteRow('<?php echo $row['pk_fichero']; ?>','video');">
                                    </td>
                                </tr>
                                <?php
                                }
